...
function changeTo(list) {
  let intros = {"Home": ' <p id="introText" class="introText"><b>How the website works - PLEASE READ:</b><br><br>Before you dive in to using this website, please consider all of its aspects. When you were given the link to this website, and every time you come back to it, it will show up in your history - as google classroom of course. The link to this site itself if completely invisible - if you look at the title and URL of this page, they are about:blank, which does not show up in history. But to make it even more masked, when you click on a game, you will see that it reloads the first page to the real google classroom, and removes the link to the origional site from your history completely. <br><br><b>Useful functions of the site - PLEASE READ:</b><br><br>If a teacher is suspicious of what the web page with the password entry is, then you can say that it was simply a coding exercise and you can enter "classroom" as your password. This will then open up google classroom and not the games website. Finally, both in the nav bar and at the bottom, is an escape button. If someone is about to come past, you can press one of them and you will be brought to google classroom as well.<br><br>Thank you for reading. Have fun! (If you have any suggestions for games I could feasibly add to the site, then please do contact me - I love the feedback!)<br><br><b>Credit to 3kh0 for many of the games!</b></p>", "Scratch": "<br>Just click on a scratch game to begin!", "Other": "Above are the best games this site currently has to offer. They are a mixture of games from construct.net and a games repositry from 3kh0 on Github (and a few others). If you have any suggestions for any more games, I will try my best to add them.'}
